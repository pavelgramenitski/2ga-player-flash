package com.rightster.player.skin {
	 ...
	 * @author KJR
	 */
	public class Gplus extends Sprite implements ISocialButton {
		...
		public function Gplus(controller : IController) {
		...
		public function sharingIsValid() : Boolean {
			return ( controller.video.googlePlusShare && !controller.placement.forceDisableSharing) ? true : false;
		}
		...
		private function createChildren() : void {
			bg = new Sprite();
			addChild(bg);
			var Texture : Class = TextureAtlas.getNewTextureClassByName(TextureAtlas.GplusIcon);
			var rect : Rectangle = TextureAtlas.getTextureClassDimensionsByName(TextureAtlas.GplusIcon);
			icon = new Texture();
