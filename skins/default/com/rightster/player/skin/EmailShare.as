package com.rightster.player.skin {
	 ...
	 * @author KJR
	 */
	public class EmailShare extends Sprite implements ISocialButton {
		...
		public function sharingIsValid() : Boolean {
			return ( controller.video.isEmail && !controller.placement.forceDisableSharing) ? true : false;
		}
		...
		private function createChildren() : void {
			bg = new Sprite();
			addChild(bg);
			var Texture : Class = TextureAtlas.getNewTextureClassByName(TextureAtlas.EmailIcon);
			var rect : Rectangle = TextureAtlas.getTextureClassDimensionsByName(TextureAtlas.EmailIcon);
			icon = new Texture();
