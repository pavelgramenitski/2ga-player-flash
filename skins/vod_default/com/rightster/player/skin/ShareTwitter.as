package com.rightster.player.skin {
	 ...
	 * @author Arun
	 */
	public class ShareTwitter extends Sprite {
		private static const T_ASSET : String = "t_mc";
		private static const SHARE_ASSET : String = "share_mc";
		private static const BG_ASSET : String = "bg_mc";
		
		private var controller : IController;
		private var tAsset : Sprite;
		...
		public function ShareTwitter(controller : IController) : void {
		...
		private function setStyle() : void {
			tAsset.transform.colorTransform = Colors.primaryCT;	
		...
		private function stateChange(e : PlayerStateEvent) : void {
			if (controller.video.twitterShareText && !controller.placement.forceDisableSharing) {
