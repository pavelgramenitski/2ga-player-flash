package com.rightster.player.skin {
	 ...
	 * @author Ravi Thapa
	 */
	public class ShareTumblr extends Sprite {
		...
		public function ShareTumblr(controller : IController) : void {
		...
		private function stateChange(e : PlayerStateEvent) : void {
			if (controller.video.enableShareTumblr && !controller.placement.forceDisableSharing) {
