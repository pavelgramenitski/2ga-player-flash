...
package com.google.analytics
{
    ...
    public class GATracker implements AnalyticsTracker
    {
		...
		private var _forceSecure : Boolean;
        /**
         ...
         */
        public function GATracker(display:DisplayObject, account:String, forceSecure : Boolean,
        ...
        */
        private function _trackerFactory():GoogleAnalyticsAPI
        {
            ...
            */
            ...
            _env        = new Environment( "", "", "", debug, _dom, _forceSecure);
            ...
            */
			...
			//_debug.warning("Host name="+_dom.host);
			_domain = "";
			if(_dom.host != null){
				_domain = _dom.protocol+"//"+_dom.host;
			}
            _env.url =  _domain; /*_display.stage.loaderInfo.url;*/
