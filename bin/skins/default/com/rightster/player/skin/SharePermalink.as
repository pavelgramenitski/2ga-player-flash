package com.rightster.player.skin {
	 ...
	 * @author KJR
	 */
	public class SharePermalink extends Sprite implements ISocialButton {
		private static const EVENT_NAME : String = "showPermaLink";
		...
		public function SharePermalink(controller : IController) : void {
		...
		public function sharingIsValid() : Boolean {
			return ( controller.video.readMoreUrl && !controller.placement.forceDisableSharing) ? true : false;
		}
		...
		private function clickHandler(e : MouseEvent) : void {
			...
			controller.dispatchEvent(new Event(EVENT_NAME));
		}
		...
		private function createChildren() : void {
			bg = new Sprite();
			addChild(bg);
			var Texture : Class = TextureAtlas.getNewTextureClassByName(TextureAtlas.PermalinkIcon);
			var rect : Rectangle = TextureAtlas.getTextureClassDimensionsByName(TextureAtlas.PermalinkIcon);
			icon = new Texture();
